...
"""
Comparison of radial vorticity balance.
"""
...
nn = 9.9e+20
path = "../../CSDXNeutralScanAr/visualizationNormalized/nn_{}/field1D/vortD-radial-1D-0.pickle".format(nn)
...
nnAx.text(0.045, -3.75e25, parTxt, color=parDer.get_color(),\
           va="center", ha="center", size=size,\
           bbox={"facecolor":"white",\
                 "edgecolor":"none" ,\
                 "boxstyle" :"round",\
...
nnAx.text(0.065, 0, ddtTxt, color="k",\
           va="center", ha="center", size=size,\
           bbox={"facecolor":"white",\
                 "edgecolor":"none" ,\
                 "boxstyle" :"round",\
...
nn = 0
path = "../../CSDXMagFieldScanAr/visualizationNormalized/B0_0.06/field1D/vortD-radial-1D-0.pickle"
with open(path, "rb") as f:
...
current   = normalAx.get_lines()[minInd]
parDer = normalAx.get_lines()[maxInd]

currentTxt = r"$\frac{1}{e}\partial_\parallel j_\parallel$"
normalAx.text(0.071, -4e25, currentTxt, color=current.get_color(),\
           va="center", ha="center", size=size,\
           bbox={"facecolor":"white",\
                 "edgecolor":"none" ,\
                 "boxstyle" :"round",\
...
parTxt = (r"$-\partial_\parallel \nabla\cdot"
          r"\left(u_{i,\parallel}"
          r"n \nabla_\perp \frac{\phi}{B} \right)$")
normalAx.text(0.0425, 4e25, parTxt, color=parDer.get_color(),\
           va="center", ha="center", size=size,\
           bbox={"facecolor":"white",\
                 "edgecolor":"none" ,\
                 "boxstyle" :"round",\
...
ddtTxt = r"$\partial_t \Omega^D$"
normalAx.text(0.025, 0, ddtTxt, color="k",\
           va="center", ha="center", size=size,\
           bbox={"facecolor":"white",\
                 "edgecolor":"none" ,\
                 "boxstyle" :"round",\
...
z = float(theSplit[1].split("$")[2])*rhoS
