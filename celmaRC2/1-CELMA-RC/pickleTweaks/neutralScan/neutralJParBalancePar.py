...
"""
Comparison of parallel current balance.
"""
...
nn = 9.9e+20
path = "../../CSDXNeutralScanAr/visualizationNormalized/nn_{}/field1D/jPar-parallel-1D-0.pickle".format(nn)
...
nnAx.text(1.6, -8e10, boltzmannTxt, color=boltzmann.get_color(),\
...
resTxt = r"$n\nu_{en}u_{e,\parallel}$"
nnAx.text(1.6, 8e10, resTxt, color=resistivity.get_color(),\
           va="center", ha="center", size=size,\
           bbox={"facecolor":"white",\
                 "edgecolor":"none" ,\
                 "boxstyle" :"round",\
...
nnAx.text(1.6, 0, ddtTxt, color="k",\
           va="center", ha="center", size=size,\
           bbox={"facecolor":"white",\
                 "edgecolor":"none" ,\
                 "boxstyle" :"round",\
...
boltzmannTxt = r"$\mu n\partial_{\parallel}\left(T_e \ln(n) - \phi \right)$"
normalAx.text(1.4, -1.8e8, boltzmannTxt, color=boltzmann.get_color(),\
           va="center", ha="center", size=size,\
           bbox={"facecolor":"white",\
                 "edgecolor":"none" ,\
                 "boxstyle" :"round",\
...
resTxt = r"$-0.51 \nu_{ei}j_{\parallel}$"
normalAx.text(1.4, 1.8e8, resTxt, color=resistivity.get_color(),\
           va="center", ha="center", size=size,\
           bbox={"facecolor":"white",\
                 "edgecolor":"none" ,\
                 "boxstyle" :"round",\
...
ddtTxt = r"$\partial_t j_\parallel$"
normalAx.text(1.4, 0, ddtTxt, color="k",\
           va="center", ha="center", size=size,\
           bbox={"facecolor":"white",\
                 "edgecolor":"none" ,\
                 "boxstyle" :"round",\
...
PlotHelper.savePlot(fig, "jParBalanceNnComparePar.pdf")
