...
"""Post-processor test for energy"""
...
from CELMAPy.energy import DriverEnergy, driverEnergy

#{{{energyTest
def energyTest():
    """
    Runs the test for the energies
    """
