...
# restart      = None;
restart_from = "a-data/nout_2_timestep_50.0/cst_nuEI_5_tag_0-a-0.2-2.1-CompareW5CELMA0h0RestartNuEI5_0/"
remove_old = False
nout       = [100]
timestep   = [2]
directory  = "a-data"
...
showPlot   = False
savePlot   = True
theRunName = "0-a-0.2-2.2-CompareW5CELMA0h0RestartNuEI5"
# =============================================================================
