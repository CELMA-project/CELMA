...
private:
    ...
    bool useHyperPerpLnN;     // If false, normal diffusion will be used
    bool useHyperPerpUEPar;   // If false, normal diffusion will be used
    bool useHyperPerpUIPar;   // If false, normal diffusion will be used
    bool useHyperPerpVortD;   // If false, normal diffusion will be used
    bool useHyperParLnN;      // If false, normal diffusion will be used
    bool useHyperParUEPar;    // If false, normal diffusion will be used
    bool useHyperParUIPar;    // If false, normal diffusion will be used
    bool useHyperParVortD;    // If false, normal diffusion will be used
    // *****************************************************************************

    // Viscosity function and vsicosity pointers
    // *****************************************************************************
    // Functions
    Field3D perpHyperVisc (const BoutReal &D, const Field3D &f);
    Field3D perpNormalVisc(const BoutReal &D, const Field3D &f);
    Field3D parHyperVisc  (const BoutReal &D, const Field3D &f);
    Field3D parNormalVisc (const BoutReal &D, const Field3D &f);
    // Function pointers
    // Perpendicular
    Field3D (Celma::*lnNPerpVisc  )(const BoutReal &D, const Field3D &f);
    Field3D (Celma::*uEParPerpVisc)(const BoutReal &D, const Field3D &f);
    Field3D (Celma::*uIParPerpVisc)(const BoutReal &D, const Field3D &f);
    Field3D (Celma::*vortDPerpVisc)(const BoutReal &D, const Field3D &f);
    // Parallel
    Field3D (Celma::*lnNParVisc  )(const BoutReal &D, const Field3D &f);
    Field3D (Celma::*uEParParVisc)(const BoutReal &D, const Field3D &f);
    Field3D (Celma::*uIParParVisc)(const BoutReal &D, const Field3D &f);
    Field3D (Celma::*vortDParVisc)(const BoutReal &D, const Field3D &f);
    // *****************************************************************************
