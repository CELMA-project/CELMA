...
int Celma::init(bool restarting) {
    ...
    // Get the ramps
    // ************************************************************************
    Options *rmp = options->getSection("rmp");
    rmp->get("nuEIStart", nuEIStart, nuEI);
    rmp->get("nuEISlope", nuEISlope,   1);
    // ************************************************************************
...
int Celma::rhs(BoutReal t) {
    ...
    // Calculate the current ei collision frequency
    nuEICur = nuEISlope*t + nuEIStart;
    ...
    uEParRes         = - 0.51*nuEICur *( uEPar - uIPar) ;
    ...
    uIParRes         = - (0.51*nuEICur/mu) *(uIPar - uEPar);
