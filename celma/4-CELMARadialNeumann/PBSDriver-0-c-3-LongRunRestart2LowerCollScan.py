...
from plotting import combined1D2D

# The options for the run
# =============================================================================
# *****************************************************************************
eiCollisions = [90, 80, 70, 60, 50, 10, 1, 0.1]
# *****************************************************************************
# Set the temporal domain
restart    = "overwrite"
# Uncomment this if you just want to plot
# restart      = None;
restart_from = "c-smallerCylinderNoDamp/nout_20_timestep_5.0/cst_nuEI_100_tag_0-c-2-LongRunRestartLowerCollScan_0/"
remove_old = False
nout       = [20]
timestep   = [5e0]
...
showPlot   = False
savePlot   = True
theRunName = "0-c-3-LongRunRestart2LowerCollScan"
# =============================================================================
