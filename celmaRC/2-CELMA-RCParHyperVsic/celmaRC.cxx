...
int CelmaCurMom::init(bool restarting)
{
    ...
    if(saveTerms){
        ...
        SAVE_REPEAT3(jParParArtVisc, jParPerpArtVisc, jParHyperVisc);
        // momDensPar terms
...
int CelmaCurMom::rhs(BoutReal t)
{
    ...
    jParHyperVisc   = - artHyperParCur*D4DY4(jPar);
...
void CelmaCurMom::setAndSaveViscosities()
{
    ...
    visc->get("artHyperParCur"    , artHyperParCur    , 0.0);
...
void CelmaCurMom::timestepInitialization()
{
    ...
    // Communicate as we are using D4DY4
    ownBC.extrapolateYUpScondGhost(jPar);
