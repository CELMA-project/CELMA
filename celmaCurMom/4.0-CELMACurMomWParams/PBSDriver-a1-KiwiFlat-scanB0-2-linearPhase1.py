...
for Lx, Ly, B0 in zip(Lxs, Lys, B0s):
    restart_from  = "a1-KiwiFlat/nout_2_timestep_5/nz_256/geom_Lx_{0}_geom_Ly_{1}_input_B0_{2}_ownFilters_type_none_tag_a1-KiwiFlat-B0-{2}-1-expand_0/".format(Lx, Ly, B0)
