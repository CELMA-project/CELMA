...
#{{{Main options
#{{{The scan
nuENUnormalized = [1.0e-1  , 9.0e-2  , 8.0e-2   , 7.0e-2 , 6.0e-2  , 5.0e-2  ]
nuINUnormalized = [4.8296  , 4.3466  , 3.8637   , 3.3807 , 2.8978  , 2.4148  ]
scanParameters  = ["nuENUnormalized", "nuINUnormalized"]
series_add = [\
              ('input', 'nuENUnormalized', nuENUnormalized),\
              ('input', 'nuINUnormalized', nuINUnormalized),\
             ]
#}}}
