...
#{{{Init options
# Name
theRunName = "a2-KiwiFlatElTempTi0-0-initialize"
...
# Name
theRunName = "a2-KiwiFlatElTempTi0-1-expand"
# PBS options
...
nout     = [500]
# Name
theRunName = "a2-KiwiFlatElTempTi0-2-linearPhase1"
# PBS options
BOUT_run_name         = theRunName
...
timestep = [1]
# Name
theRunName = "a2-KiwiFlatElTempTi0-3-turbulentPhase1"
# PBS options
BOUT_run_name         = theRunName
BOUT_walltime         = '100:00:00'
post_process_run_name = 'post' + theRunName.capitalize()
...
if postProcessProbesAndEnergy:
    collectionFolders = [linear_dmp_folders[0],\
                         turbo_dmp_folders[0]]
    theRunName = "a2-KiwiFlatElTempTi0-all-energyProbesPlot"
    curPostProcessor = postBoutRunner
