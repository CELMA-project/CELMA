...
#include "D4DY4Cylinder.hxx"

// Initialization of the physics
// ############################################################################
int D4DY4Cylinder::init(bool restarting) {
    TRACE("Halt in D4DY4Cylinder::init");
...
// ############################################################################
int D4DY4Cylinder::rhs(BoutReal t) {
    return 0;
}
// ############################################################################

// Create a simple main() function
BOUTMAIN(D4DY4Cylinder);

// Destructor
D4DY4Cylinder::~D4DY4Cylinder(){
    TRACE("D4DY4Cylinder::~D4DY4Cylinder");
}
