// *************** Simulation of DDXCylinderWithJacobian *********************
/* Geometry
...
#include "DDXCylinderWithJacobian.hxx"

// Initialization of the physics
// ############################################################################
int DDXCylinderWithJacobian::init(bool restarting) {
    TRACE("Halt in DDXCylinderWithJacobian::init");
...
// ############################################################################
int DDXCylinderWithJacobian::rhs(BoutReal t) {
    return 0;
}
// ############################################################################

// Create a simple main() function
BOUTMAIN(DDXCylinderWithJacobian);

// Destructor
DDXCylinderWithJacobian::~DDXCylinderWithJacobian(){
    TRACE("DDXCylinderWithJacobian::~DDXCylinderWithJacobian");
}
