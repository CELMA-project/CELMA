...
#include "D3DX2DZCylinder.hxx"

// Initialization of the physics
// ############################################################################
int D3DX2DZCylinder::init(bool restarting) {
    TRACE("Halt in D3DX2DZCylinder::init");
...
// ############################################################################
int D3DX2DZCylinder::rhs(BoutReal t) {
    return 0;
}
// ############################################################################

// Create a simple main() function
BOUTMAIN(D3DX2DZCylinder);

// Destructor
D3DX2DZCylinder::~D3DX2DZCylinder(){
    TRACE("D3DX2DZCylinder::~D3DX2DZCylinder");
}
