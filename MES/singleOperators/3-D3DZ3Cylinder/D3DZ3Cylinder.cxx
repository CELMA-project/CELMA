...
#include "D3DZ3Cylinder.hxx"

// Initialization of the physics
// ############################################################################
int D3DZ3Cylinder::init(bool restarting) {
    TRACE("Halt in D3DZ3Cylinder::init");
...
// ############################################################################
int D3DZ3Cylinder::rhs(BoutReal t) {
    return 0;
}
// ############################################################################

// Create a simple main() function
BOUTMAIN(D3DZ3Cylinder);

// Destructor
D3DZ3Cylinder::~D3DZ3Cylinder(){
    TRACE("D3DZ3Cylinder::~D3DZ3Cylinder");
}
