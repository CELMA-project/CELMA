...
#include "modifiedArakawa.hxx"

// Initialization of the physics
// ############################################################################
int modifiedArakawa::init(bool restarting) {
    TRACE("Halt in modifiedArakawaf2::init");
...
// ############################################################################
int modifiedArakawa::rhs(BoutReal t) {
    return 0;
}
// ############################################################################

// Create a simple main() function
BOUTMAIN(modifiedArakawa);

// Destructor
modifiedArakawa::~modifiedArakawa(){
    TRACE("modifiedArakawaf2::~modifiedArakawaf2");
}
