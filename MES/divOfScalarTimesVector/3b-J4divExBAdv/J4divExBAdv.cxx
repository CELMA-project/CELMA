...
#include "J4divExBAdv.hxx"

// Initialization of the physics
// ############################################################################
int J4DivExBAdv::init(bool restarting) {
    TRACE("Halt in J4DivExBAdv::init");
...
// ############################################################################
int J4DivExBAdv::rhs(BoutReal t) {
    return 0;
}
// ############################################################################

// Create a simple main() function
BOUTMAIN(J4DivExBAdv);

// Destructor
J4DivExBAdv::~J4DivExBAdv(){
    TRACE("J4DivExBAdv::~J4DivExBAdv");
}
