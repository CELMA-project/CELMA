...
class CelmaApar : public PhysicsModel
{
protected:
...
private:
    ...
    // Evolved variables
    // *****************************************************************************
    Field3D jMPar, momDensPar;    // Parallel velocities
    ...
    Field3D jParRes, AParDdtLnN;
    Field3D nGradParPhiLnN, neutralERes, neutralIRes;
    Field3D jMParParArtVisc, jMParPerpArtVisc;
    Field3D jPar, APar;
    // momDensPar fields
    ...
    BoutReal artViscParLnN, artViscParJMPar, artViscPerpJMPar;
    ...
    Laplacian *AParSolver;          // The APar solver
