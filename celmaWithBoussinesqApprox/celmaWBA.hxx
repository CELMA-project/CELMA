...
class CelmaWBA : public PhysicsModel {
protected:
...
private:
  ...
  int outputMonitor(BoutReal simtime, int iter,
                    int NOUT); // Monitors every output
  // *****************************************************************************
  ...
  bool constViscHyper; // If the input hyper viscosity is the simulation
                       // viscosity
  bool viscosityGuard; // If a check should be performed for the artificial
                       // viscosity
  // *****************************************************************************
